...
export const AREA_HAZARD_REGISTRY: Record<string, AreaHazardProfile> = {
  ...
  'Meppadi': {
    name: 'Meppadi (Disaster Epicenter)',
  ...
  // 1B. MUNDAKKAI (Upper Debris Flow Initiation Corridor)
  'Mundakkai': {
    name: 'Mundakkai (Upper Debris Origin)',
    category: 'Disaster Epicenter',
    riskScore: 89.2,
    riskLevel: 'HIGH',
    landslideProb: 96,
    ...
    soilMoisture: 99,
    historyFreq: 98,
    censusPopulation: 3820,
    exposedPopulation: 1450,
    familiesCount: 110,
    highRiskParcels: 110,
    totalParcels: 110,
    primaryHazard: 'Catastrophic Regolith Detachment & Debris Avalanche Initiation',
    summary: 'Extreme convergence of 42.4° scarp detachment angle, 312mm rainfall saturation, and torrential channel headwaters.',
    actionRequired: 'Total red-zone evacuation; zero re-habitation zone.',
    assignedSafeSite: 'Kalpetta-Vythiri Institutional Reserve (CCAS 93.4)',
    coordinates: [11.538, 76.136],
    polygonBounds: [
      [11.528, 76.125],
      [11.548, 76.125],
      [11.548, 76.148],
  ...
  // 1C. CHOORALMALA (Debris Deposition & Bridge Confluence)
  'Chooralmala': {
    ...
    soilMoisture: 96,
    historyFreq: 94,
    censusPopulation: 5410,
    exposedPopulation: 2200,
    familiesCount: 140,
    highRiskParcels: 140,
    totalParcels: 140,
    primaryHazard: 'High-Velocity Debris Runout & Flash Flood Confluence',
    summary: 'Bottleneck bridge constriction receiving high-velocity debris flows from Mundakkai and Chembra tributaries.',
    actionRequired: 'Emergency clearance and safe relocation to designated upland plateaus.',
    assignedSafeSite: 'Kalpetta-Vythiri Institutional Reserve (CCAS 93.4)',
    coordinates: [11.547, 76.126],
    polygonBounds: [
      [11.538, 76.115],
      [11.558, 76.115],
      [11.558, 76.138],
  ...
  // 1D. CHEMBRA (High Mountain Peak & Headwall Scarp)
  'Chembra': {
    ...
    soilMoisture: 99,
    historyFreq: 95,
    censusPopulation: 420,
    exposedPopulation: 180,
    familiesCount: 15,
    highRiskParcels: 15,
    totalParcels: 15,
    primaryHazard: 'Steep Headwall Scarp Regolith Failure',
    summary: 'Highest peak massif in southern Wayanad (1,657m); source of extreme precipitation catch and channel acceleration.',
    actionRequired: 'Protected watershed sanctuary; non-habitable terrain.',
    assignedSafeSite: 'Kalpetta-Vythiri Institutional Reserve (CCAS 93.4)',
    coordinates: [11.512, 76.088]
  },

  // 1E. WAYANAD (District Regional Context)
  'Wayanad': {
    name: 'Wayanad District (Regional Topography)',
    ...
    exposedPopulation: 14200,
    familiesCount: 1250,
    highRiskParcels: 420,
    totalParcels: 1850,
    primaryHazard: 'Regional Monsoon Multi-Hazard Exposure',
    summary: 'Plateau district bounded by Western Ghats scarp margins; high contrast between 2,000m crests and 700m river basins.',
    actionRequired: 'SDMA District Command coordination across all vulnerable taluks.',
    assignedSafeSite: 'Kalpetta-Vythiri Institutional Reserve (CCAS 93.4)',
    coordinates: [11.605, 76.085]
  },
...
export interface MicroCatchmentItem {
  catchmentId: string;
  name: string;
  village: string;
...
export const MICRO_CATCHMENTS_DATA: MicroCatchmentItem[] = [
  {
    ...
    polygon: [[11.520, 76.120], [11.520, 76.150], [11.545, 76.155], [11.550, 76.125], [11.520, 76.120]]
  },
  {
    catchmentId: 'MC_MEPPADI_02',
    name: 'Mundakkai Valley Runout Basin',
    village: 'Meppadi',
    centroid: [11.545, 76.130],
    areaKm2: 3.45,
    meanElevationM: 920.0,
    meanSlopeDeg: 29.2,
    baseRain24h: 280.0,
    baseRain48h: 365.0,
    baseRain72h: 530.0,
    ...
    mmiScore: 78.0,
    operatingMode: 'AUTONOMOUS',
    polygon: [[11.535, 76.115], [11.535, 76.145], [11.560, 76.140], [11.555, 76.110], [11.535, 76.115]]
  },
  {
    catchmentId: 'MC_MEPPADI_03',
    name: 'Chooralmala Confluence Corridor',
    village: 'Meppadi',
    centroid: [11.554, 76.128],
    areaKm2: 2.90,
    meanElevationM: 780.0,
    meanSlopeDeg: 22.4,
    baseRain24h: 275.0,
    baseRain48h: 355.0,
    baseRain72h: 510.0,
    ...
    mmiScore: 78.0,
    operatingMode: 'AUTONOMOUS',
    polygon: [[11.545, 76.110], [11.545, 76.140], [11.570, 76.135], [11.565, 76.105], [11.545, 76.110]]
  },
  {
    catchmentId: 'MC_ACHOOR_01',
    name: 'Achooranam Western Slopes',
    village: 'Achooranam',
    centroid: [11.585, 76.015],
    areaKm2: 4.15,
    meanElevationM: 890.0,
    meanSlopeDeg: 26.5,
    baseRain24h: 178.0,
    baseRain48h: 245.0,
    baseRain72h: 380.0,
    ...
    polygon: [[11.570, 76.000], [11.570, 76.030], [11.600, 76.035], [11.600, 76.005], [11.570, 76.000]]
  },
  {
    catchmentId: 'MC_KOTTATHARA_01',
    name: 'Kabini River Lowland Basin',
    village: 'Kottathara',
    centroid: [11.685, 76.035],
    areaKm2: 6.40,
    meanElevationM: 725.0,
    meanSlopeDeg: 6.8,
    baseRain24h: 142.0,
    baseRain48h: 190.0,
    baseRain72h: 290.0,
    ...
    mmiScore: 64.0,
    operatingMode: 'ASSISTED',
    polygon: [[11.670, 76.020], [11.670, 76.050], [11.700, 76.050], [11.700, 76.020], [11.670, 76.020]]
  },
  {
    catchmentId: 'MC_KUPPADITHARA_01',
    name: 'Kuppadithara Agricultural Plain',
    village: 'Kuppadithara',
    centroid: [11.655, 76.015],
    areaKm2: 5.20,
    meanElevationM: 735.0,
    meanSlopeDeg: 7.4,
    baseRain24h: 128.0,
    baseRain48h: 170.0,
    baseRain72h: 260.0,
    ...
    mmiScore: 62.0,
    operatingMode: 'ASSISTED',
    polygon: [[11.640, 76.000], [11.640, 76.030], [11.670, 76.030], [11.670, 76.000], [11.640, 76.000]]
  }
];

export interface RunoutCorridorItem {
  id: string;
  name: string;
...
export const RUNOUT_CORRIDORS_DATA: RunoutCorridorItem[] = [
  {
    id: 'RUNOUT-MEPPADI-01',
    name: 'Chembra Scarp to Chooralmala Bridge',
    sourceVillage: 'Meppadi',
    velocityKmh: 48.5,
    leadTimeMin: 18,
    riskLevel: 'CRITICAL',
    path: [[11.535, 76.135], [11.545, 76.130], [11.554, 76.128], [11.565, 76.115], [11.575, 76.102]]
  },
  {
    id: 'RUNOUT-MEPPADI-02',
    name: 'Mundakkai Tributary Debris Channel',
    sourceVillage: 'Meppadi',
    velocityKmh: 41.2,
    leadTimeMin: 24,
    riskLevel: 'HIGH',
    path: [[11.542, 76.140], [11.550, 76.132], [11.554, 76.128]]
  },
  {
    id: 'RUNOUT-ACHOOR-01',
    name: 'Achoor Foothill Siltation Runout',
    sourceVillage: 'Achooranam',
    velocityKmh: 22.0,
    leadTimeMin: 45,
    riskLevel: 'MEDIUM',
    path: [[11.585, 76.015], [11.595, 76.025], [11.605, 76.035]]
  }
];
