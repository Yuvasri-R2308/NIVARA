      ...
      <div className="flex flex-wrap items-center justify-between gap-2 bg-[#111D18]/95 backdrop-blur-md border border-[#1E3228] px-3 py-2 rounded-xl shadow-panel z-10">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="px-3 py-1 bg-rose-950/90 hover:bg-rose-900 text-rose-300 border border-rose-700 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 shrink-0 shadow-sm"
            title="Exit Map and return to Area Comparison"
          >
